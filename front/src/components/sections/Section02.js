                ...
                <div className='width_con'>
                    <ul className='three_con'>
                        <li>
                            ...
                            <div className='desc'><h5>원하는 땅을 찾아보세요<br></br>얼마에 어떤 건물을 지을 수 있는지 직접 확인하세요.</h5></div>
                        ...
                        <li>
                            ...
                            <div className='row'></div>
                            <div className='desc'><h5>Web기반의 3D뷰어로,<br></br>언제 어디서나 여러분의 계획안을 직관적으로 확인하세요.</h5></div>
                            <div className='image'><img src={process.env.PUBLIC_URL+"images/ratio_1x1.png"}></img></div>
                        </li>
                        <li>
                            <div className='title'><h2>집 짓는데 필요한 필수 정보 컨설팅</h2></div>
                            <div className='row'></div>
                            <div className='desc'><h5>집을 짓기에 필요한 수많은 궁금증<br></br>언제든 물어보고 결정하세요.</h5></div>
                            <div className='image'><img src={process.env.PUBLIC_URL+"images/ratio_1x1.png"}></img></div>
                        </li>
                    </ul>
                </div>
